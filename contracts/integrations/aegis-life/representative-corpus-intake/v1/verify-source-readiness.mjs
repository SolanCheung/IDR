...
expectedGateStatuses.SOURCE_SPECIFIC_EXPORT_APPROVAL =
  "SPECIFIED_NOT_IMPLEMENTED";
expectedGateStatuses.TRUSTED_EXPORT_AND_VERIFICATION_CLOCK =
  "SPECIFIED_NOT_IMPLEMENTED";
expectedGateStatuses.HOST_PROJECTION_SEMANTIC_MAPPING =
  "SPECIFIED_NOT_IMPLEMENTED";
...
console.log("SOURCE_SPECIFIC_EXPORT_APPROVAL=SPECIFIED_NOT_IMPLEMENTED");
console.log("TRUSTED_EXPORT_AND_VERIFICATION_CLOCK=SPECIFIED_NOT_IMPLEMENTED");
console.log("CONSENT_OR_LAWFUL_BASIS=UNRESOLVED");
console.log("HOST_PROJECTION_SEMANTIC_MAPPING=SPECIFIED_NOT_IMPLEMENTED");
