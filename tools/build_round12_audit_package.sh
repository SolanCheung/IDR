...
output_zip="${1:-/Users/solan/Downloads/IDR-V1.3-trust-chain-closure-round12-2026-07-30.zip}"
...
stage_parent="$(mktemp -d "${TMPDIR:-/tmp}/idr-round12-package.XXXXXX")"
package_name="IDR-V1.3-trust-chain-closure-round12-2026-07-30"
...
copy_file \
    "${idr_root}/docs/audit/IDR_V1_3_ROUND12_PACKAGE_README.md" \
    "${package_root}/README.md"
copy_file \
    "${idr_root}/docs/audit/IDR_V1_3_ROUND12_AUDIT_MANIFEST.md" \
    "${package_root}/AUDIT-MANIFEST.md"
copy_file \
    "${idr_root}/docs/trust-chain-closure/ROUND12-REAUDIT-RESPONSE.md" \
    "${package_root}/ROUND12-REAUDIT-RESPONSE.md"
copy_file \
