...
output_zip="${1:-/Users/solan/Downloads/IDR-V1.3-trust-chain-closure-round11-2026-07-30.zip}"
...
stage_parent="$(mktemp -d "${TMPDIR:-/tmp}/idr-round11-package.XXXXXX")"
package_name="IDR-V1.3-trust-chain-closure-round11-2026-07-30"
...
copy_file \
    "${idr_root}/docs/audit/IDR_V1_3_ROUND11_PACKAGE_README.md" \
    "${package_root}/README.md"
copy_file \
    "${idr_root}/docs/audit/IDR_V1_3_ROUND11_AUDIT_MANIFEST.md" \
    "${package_root}/AUDIT-MANIFEST.md"
copy_file \
    "${idr_root}/docs/trust-chain-closure/ROUND11-REAUDIT-RESPONSE.md" \
    "${package_root}/ROUND11-REAUDIT-RESPONSE.md"
copy_file \
